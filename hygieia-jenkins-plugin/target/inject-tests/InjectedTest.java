...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/opt/hygiea/Hygieia/hygieia-jenkins-plugin");
    parameters.put("artifactId","hygieia-publisher");
    parameters.put("outputDirectory","/opt/hygiea/Hygieia/hygieia-jenkins-plugin/target/classes");
    parameters.put("testOutputDirectory","/opt/hygiea/Hygieia/hygieia-jenkins-plugin/target/test-classes");
